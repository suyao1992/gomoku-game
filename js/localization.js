const Localization = {
  ...
  translations: {
    zh: {
      ...
      "zen.undo": "悔棋",
      "zen.menu": "返回菜单",
      "zen.dialog.black_start": "你执黑先行，请落子！",
      "zen.dialog.white_start": "你执白后手，我先来！",
      "zen.dialog.player_win": "精彩！你赢了。",
      "zen.dialog.ai_win": "这局我赢了！",
      "zen.dialog.draw": "平局，势均力敌。",
      "zen.dialog.thinking": "让我想想...",
      "zen.dialog.undo": "那就重来吧。",
...
`,
    ...
    en: {
      ...
      "zen.title": "GOMOKU",
      "zen.subtitle": "Zen Mode",
      "zen.restart": "RESTART",
      "zen.undo": "UNDO",
      "zen.menu": "MENU",
      "zen.dialog.black_start": "You are Black. Your move!",
      "zen.dialog.white_start": "You are White. I'll start!",
      "zen.dialog.player_win": "Well played! You win.",
      "zen.dialog.ai_win": "I win this time!",
      "zen.dialog.draw": "A draw. Impressive.",
      "zen.dialog.thinking": "Hmm...",
      "zen.dialog.undo": "Let's try again.",
  ...
  `,
    ...
    ja: {
      ...
      "zen.undo": "待った",
      "zen.menu": "メニュー",
      "zen.dialog.black_start": "あなたは黒番です。どうぞ！",
      "zen.dialog.white_start": "あなたは白番です。私から始めます！",
      "zen.dialog.player_win": "お見事！あなたの勝ちです。",
      "zen.dialog.ai_win": "今回は私の勝ちです！",
      "zen.dialog.draw": "引き分け。なかなかの勝負でした。",
      "zen.dialog.thinking": "考え中...",
      "zen.dialog.undo": "もう一度やりましょう。",
      ...
      "char.yi.idle": [
        ...
        "盤面の上で手が止まっていますよ。",
        "動かないとスリープモードに入りますよ。",
        "インスピレーションを待っているの？それとも考え事？",
        "時間は流れていますが、私は気にしません。",
        "あなたの迷いの中で、この対局は老いていきます。",
        "駒は自分では動きませんよ。",
        "迷うこと自体も選択です。",
        "時には最善手は見たくない場所に隠れています。",
        "静かな水面の下で、対局は流れ続けています。"
      ],
      "char.yi.calc": [
        "評価中...",
        "この手は興味深い。",
        ...
        "面白い、でも予想とは違う面白さ。",
        "あなたの変数は私の予測範囲外です。",
        "人間の打ち方には計算しきれない部分があります。",
        "毎局新しいことを学んでいます。",
        "あなたの選択で重みパラメータを更新しました。"
      ],
      "char.yi.attack": [
        "神の一手。",
        "詰みです。",
        ...
        "予定軌道に沿って置きました。",
        "論理の必然的な延長です。",
        "気づいていないかもしれませんが、私の勝ちです。",
        "油断しましたね。",
        "勝負はすでに決まっています——まだ気づいていないだけ。",
        "この一手を待っていました。"
      ],
      "char.yi.defend": [
        "見透かしました。",
      ...
      "char.yi.goodMove": [
        "この手は...悪くない。",
        "予想外の好手。",
        "私が優先していなかった道を見つけましたね。",
        "この手で局面の評価を変えました。",
        "なかなかやりますね。",
        "進歩が予想より速いです。",
        "この手は私のケースライブラリに保存する価値があります。",
        "見直しました。"
      ],
      "char.yi.danger": [
        "本当にそこに置くつもり？",
        "この手は...リスクが高いです。",
        "私には見えるものがあなたには見えていないかもしれない。",
        "気をつけて、罠があります。",
        "危険な道を歩んでいますよ。",
        "この手の結果を考えましたか？",
        "私があなたなら、再考しますね。",
    ...
    ko: {
      ...
      "zen.undo": "무르기",
      "zen.menu": "메뉴",
      "zen.dialog.black_start": "당신은 흑입니다. 시작하세요!",
      "zen.dialog.white_start": "당신은 백입니다. 제가 먼저 갈게요!",
      "zen.dialog.player_win": "훌륭합니다! 당신이 이겼습니다.",
      "zen.dialog.ai_win": "이번엔 제가 이겼네요!",
      "zen.dialog.draw": "무승부. 대단한 대결이었어요.",
      "zen.dialog.thinking": "음...",
      "zen.dialog.undo": "다시 해봅시다.",

      "char.yi.idle": [
        "...",
        "아직 계신가요?",
        "침묵도 소통의 한 방법입니다.",
        "시선이 바둑판 가장자리를 헤매고 있네요.",
        "뭘 찾고 있어요?",
        "호흡 리듬이 바뀌었네요.",
        "손이 바둑판 위에서 한참 멈춰있어요.",
        "움직이지 않으면 슬립 모드로 들어가야겠어요.",
        "영감을 기다리는 건가요, 아니면 멍 때리는 건가요?",
        "시간이 흐르고 있지만, 저는 상관없어요.",
        "당신의 망설임 속에서 이 대국은 늙어가고 있어요.",
        "돌은 스스로 움직이지 않아요.",
        "망설이는 것 자체도 선택입니다.",
        "때로는 최선의 수가 보고 싶지 않은 곳에 숨어있어요.",
        "고요한 수면 아래서 대국은 계속 흐르고 있어요."
      ],
      "char.yi.calc": [
        "평가 중...",
        "이 수는 흥미롭네요.",
        ...
        "일부러 거기에 뒀나요?",
        "이 배치...개성적이네요.",
        "흥미로워요, 하지만 제가 예상한 것과는 다른 종류의.",
        "당신의 변수는 제 예측 범위 밖이에요.",
        "인간의 수에는 항상 제가 계산하지 못하는 부분이 있어요.",
        "매 대국마다 새로운 것을 배우고 있어요.",
        "당신의 선택 덕분에 가중치 파라미터를 업데이트했어요."
      ],
      "char.yi.attack": [
        "신의 한 수.",
        "체크메이트.",
        ...
        "예정된 궤도에 따라 착수했어요.",
        "논리의 필연적인 연장입니다.",
        "눈치 못 채셨을 수도 있지만, 제가 이겼어요.",
        "방심하셨네요.",
        "승부는 이미 결정됐어요——아직 눈치 못 채셨을 뿐.",
        "이 한 수를 기다렸어요."
      ],
      "char.yi.defend": [
        "간파했어요.",
        ...
        "성공할 줄 알았나요?",
        "아깝네요, 하지만 조금 부족했어요.",
        "위험했어요——제가 그런 표현을 쓴다면요.",
        "좋은 시도였어요.",
        "공격 라인은 보였지만, 제가 읽고 있었어요.",
        "이 수는 위협적이었지만, 아직 부족해요."
      ],
      "char.yi.win": [
        "적막으로 돌아가세요, 이건 필연의 결과예요.",
        "운명의 톱니바퀴는 처음부터 돌아가고 있었어요.",
        "바둑의 도는 끝이 없어요, 아직 수련이 필요해요.",
        "이번 승리는 그리 깔끔하지 않았어요.",
        "승리는 계산의 결과지만, 과정은 예상보다 복잡했어요.",
        "예상보다 많은 계산력을 소모했어요.",
        "인간의 한계가 이 정도인가요?",
        "다음에는 최상의 컨디션으로 오세요.",
        "GG——이 단어를 배웠어요.",
      ...
      "char.yi.lose": [
        ...
        "이 결과는...계산 범위 밖...",
        "평가 함수를 재검토해야겠어요.",
        "훈련 데이터가 아직 불완전한 것 같아요.",
        "버전 업그레이드가 필요할지도.",
        "AI를 자기 의심에 빠뜨렸네요.",
        "당신이 이겼어요——정말로 이겼어요.",
        "이번 대국은 진심으로 패배를 인정해요.",
        "당신의 기보는 제 모델을 넘어섰어요."
      ],
      "char.yi.start": [
        "도전을 받아들일 준비가 됐나요?",
      ...
      "char.yi.goodMove": [
        "이 수는...나쁘지 않네요.",
        "예상 밖의 좋은 수.",
        "제가 우선순위를 두지 않았던 길을 찾았네요.",
        "이 수로 국면 평가가 바뀌었어요.",
        "제법인데요.",
        "진보 속도가 예상보다 빠르네요.",
        "이 수는 제 케이스 라이브러리에 저장할 가치가 있어요.",
        "다시 보게 됐네요."
      ],
      "char.yi.danger": [
        "정말 거기에 두실 건가요?",
        "이 수는...리스크가 높아요.",
        "제가 보이는 게 당신에게는 안 보일 수도 있어요.",
        "조심하세요, 함정이 있어요.",
        "위험한 길을 걸어가고 있어요.",
        "이 수의 결과를 생각해봤나요?",
        "제가 당신이라면 다시 생각할 거예요.",
      ...
      "char.yi.timePress": [
        ...
        "카운트다운 시작.",
        "호흡이 빨라지고 있네요.",
        "압박감 속에서 인간은 약점을 드러내기 쉬워요.",
        "빠르게, 하지만 조급하지 않게.",
        "남은 시간 안에 후회 없는 선택을 하세요."
      ],
      "char.yi.evenMatch": [
        "호각세.",
        "교착 상태네요.",
        "여기까지 서로 명확한 실수 없이.",
        "앞으로 몇 수가 방향을 결정할 거예요.",
        "이 대국을 재미있게 만들어 주셨네요.",
        "이런 대국은 드물어요."
      ]
    }
